...
execute if entity @a[tag=in_tutorial,tag=playing,team=eadl,scores={tutorial=270}] run tellraw @a[team=eadl,tag=playing,tag=!no_tutorial] [{"text":"- ","color":"dark_gray"},{"text":"Your goal is to gather all three and return to the ship before time runs out.","color":"gray"}]
...
execute if entity @a[tag=in_tutorial,tag=playing,team=eadl,scores={tutorial=370}] run tp @e[type=armor_stand,tag=eadl_tutorial] 8009 60 -1 -90 80
execute if entity @a[tag=in_tutorial,tag=playing,team=eadl,scores={tutorial=370}] run tellraw @a[team=eadl,tag=playing,tag=!no_tutorial] [{"text":"- ","color":"dark_gray"},{"text":"You must place the components on the ship.","color":"#e2e2e2"}]
execute if entity @a[tag=in_tutorial,tag=playing,team=eadl,scores={tutorial=370}] as @a[team=eadl,tag=playing,tag=!no_tutorial] at @s run playsound minecraft:block.note_block.pling master @s ~ ~ ~ 1000 1.25


execute if entity @a[tag=in_tutorial,tag=playing,team=eadl,scores={tutorial=480}] run tp @e[type=armor_stand,tag=eadl_tutorial] 8029 54 13 90 20
execute if entity @a[tag=in_tutorial,tag=playing,team=eadl,scores={tutorial=480}] run tellraw @a[team=eadl,tag=playing,tag=!no_tutorial] [{"text":"- ","color":"dark_gray"},{"text":"The water is cold! Going swimming will slowly start dealing damage.","color":"gray"}]
execute if entity @a[tag=in_tutorial,tag=playing,team=eadl,scores={tutorial=480}] as @a[team=eadl,tag=playing,tag=!no_tutorial] at @s run playsound minecraft:block.note_block.pling master @s ~ ~ ~ 1000 1.25

execute if entity @a[tag=in_tutorial,tag=playing,team=eadl,scores={tutorial=540}] run tp @e[type=armor_stand,tag=eadl_tutorial] 8042 55.25 9 -90 20
execute if entity @a[tag=in_tutorial,tag=playing,team=eadl,scores={tutorial=540}] run tellraw @a[team=eadl,tag=playing,tag=!no_tutorial] [{"text":"- ","color":"dark_gray"},{"text":"There are skulls everywhere in the lab.","color":"#e2e2e2"}]
...
execute if entity @a[tag=in_tutorial,tag=playing,team=eadl,scores={tutorial=590}] run tp @e[type=armor_stand,tag=eadl_tutorial] 8040 57.5 9 -90 80
execute if entity @a[tag=in_tutorial,tag=playing,team=eadl,scores={tutorial=590}] run tellraw @a[team=eadl,tag=playing,tag=!no_tutorial] [{"text":"- ","color":"dark_gray"},{"text":"Sometimes, these skulls will turn out to be actual wither skeletons.","color":"gray"}]
...
execute if entity @a[tag=in_tutorial,tag=playing,team=eadl,scores={tutorial=640}] run tp @e[type=armor_stand,tag=eadl_tutorial] 8040 56.5 9 90 40
execute if entity @a[tag=in_tutorial,tag=playing,team=eadl,scores={tutorial=640}] run tellraw @a[team=eadl,tag=playing,tag=!no_tutorial] [{"text":"- ","color":"dark_gray"},{"text":"You can't hurt these creatures, so it's best just to run.","color":"#e2e2e2"}]
execute if entity @a[tag=in_tutorial,tag=playing,team=eadl,scores={tutorial=640}] as @a[team=eadl,tag=playing,tag=!no_tutorial] at @s run playsound minecraft:block.note_block.pling master @s ~ ~ ~ 1000 1.25

execute if entity @a[tag=in_tutorial,tag=playing,team=eadl,scores={tutorial=690}] run tp @e[type=armor_stand,tag=eadl_tutorial] 8027 59 9 -90 30
execute if entity @a[tag=in_tutorial,tag=playing,team=eadl,scores={tutorial=690}] run tellraw @a[team=eadl,tag=playing,tag=!no_tutorial] [{"text":"- ","color":"dark_gray"},{"text":"The skeletons can't leave the lab.","color":"gray"}]
execute if entity @a[tag=in_tutorial,tag=playing,team=eadl,scores={tutorial=690}] as @a[team=eadl,tag=playing,tag=!no_tutorial] at @s run playsound minecraft:block.note_block.pling master @s ~ ~ ~ 1000 1.25
##Remember to alternate message colors between gray and #e2e2e2

execute if entity @a[tag=in_tutorial,tag=playing,team=eadl,scores={tutorial=740}] run function scenario:explore_a_deserted_lab/tutorial_end
