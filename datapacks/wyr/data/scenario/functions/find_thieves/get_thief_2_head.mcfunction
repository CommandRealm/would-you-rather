...
setblock 32000 0 0 oak_sign{front_text:{messages:['[{"selector":"@e[type=area_effect_cloud,tag=ft_thief_2_name,limit=1]","italic":false,"color":"yellow"}]', '{"text":""}', '{"text":""}', '{"text":""}'], has_glowing_text: false, color: "black"}} destroy
