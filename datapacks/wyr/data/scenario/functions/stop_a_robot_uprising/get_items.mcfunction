clear @s
item replace entity @s hotbar.0 with iron_sword{HideFlags:63,display:{Name:'[{"text":"Sword","italic":false,"color":"gray"}]'},Unbreakable:1b,AttributeModifiers:[{AttributeName:"generic.attack_speed",Amount:1024,UUID:[I; 1, 1, 1, 1]},{AttributeName:"generic.attack_damage",Amount:20,UUID:[I; 2, 2, 2, 2]}]}
