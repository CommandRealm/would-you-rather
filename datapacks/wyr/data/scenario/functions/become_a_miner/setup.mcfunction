...
fill 8833 133 -17 8831 156 -15 air
...
# Elevator spawn
summon minecraft:armor_stand 8833 152.5 -15 {Invulnerable:1b,NoGravity:1b,Passengers:[{id:"minecraft:shulker",DeathLootTable:"scenario/empty",active_effects:[{id:"minecraft:invisibility",amplifier:1b,duration:20000000,show_particles:0b}],NoAI:1b,Silent:1b,NoGravity:1b,Tags:["bam_elevator","bam_die"]},{id:"minecraft:falling_block",BlockState:{Name:"minecraft:spruce_planks"},Time:-2147483648,Tags:["bam_elevator","bam_die"],NoGravity:1b}],Tags:["bam_elevator","bam_die"],Invisible:1b}
...
summon minecraft:armor_stand 8832 152.5 -16 {Invulnerable:1b,NoGravity:1b,Passengers:[{id:"minecraft:shulker",DeathLootTable:"scenario/empty",active_effects:[{id:"minecraft:invisibility",amplifier:1b,duration:20000000,show_particles:0b}],NoAI:1b,Silent:1b,NoGravity:1b,Tags:["bam_elevator","bam_die"]},{id:"minecraft:falling_block",BlockState:{Name:"minecraft:spruce_planks"},Time:-2147483648,Tags:["bam_elevator","bam_die"],NoGravity:1b}],Tags:["bam_elevator","bam_die","bam_center"],Invisible:1b}
