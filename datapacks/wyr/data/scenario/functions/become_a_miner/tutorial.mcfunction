...
execute if entity @a[tag=in_tutorial,tag=playing,team=bam,scores={tutorial=90}] run tellraw @a[team=bam,tag=playing,tag=!no_tutorial] [{"text":"- ","color":"dark_gray"},{"text":"After riding the elevator down to the mineshaft, follow the particles to the diamond ore.","color":"gray"}]
...
execute if entity @a[tag=in_tutorial,tag=playing,team=bam,scores={tutorial=170}] run tellraw @a[team=bam,tag=playing,tag=!no_tutorial] [{"text":"- ","color":"dark_gray"},{"text":"Use a Fortune III pickaxe to break the diamond ore. Whoever breaks it will instantly receive the diamonds.","color":"#e2e2e2"}]
...
execute if entity @a[tag=in_tutorial,tag=playing,team=bam,scores={tutorial=270}] run tellraw @a[team=bam,tag=playing,tag=!no_tutorial] [{"text":"- ","color":"dark_gray"},{"text":"Obtain seven diamonds to win the scenario.","color":"gray"}]
...
execute if entity @a[tag=in_tutorial,tag=playing,team=bam,scores={tutorial=330}] run tellraw @a[team=bam,tag=playing,tag=!no_tutorial] [{"text":"- ","color":"dark_gray"},{"text":"Once all diamond ores have broken, the timer will lower to five seconds. Anyone without the required diamonds will lose.","color":"#e2e2e2"}]
