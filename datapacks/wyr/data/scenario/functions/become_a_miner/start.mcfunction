scoreboard players set $time bam_timer 1600
...
#execute as @e[tag=bam_spawn,type=marker] at @s if block ~ ~ ~ diamond_ore run setblock ~ ~ ~ stone
#execute as @e[tag=bam_spawn,type=marker] at @s if block ~ ~ ~ air run setblock ~ ~ ~ stone
#
