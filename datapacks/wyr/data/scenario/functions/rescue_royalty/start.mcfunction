...
execute if score $rand random matches 0 run item replace entity @e[type=armor_stand,tag=rap_royalty] armor.head with player_head{SkullOwner:{Id:[I;-1235697309,-1820310336,-2086920745,1587810776],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvZGMwNzEwOWUyNzI4YzNkMzU2YWMxYTNjNWFjZDBkZDQwZWFmOWQ5ODYzZmRlODM3YmFkZDJjYjExZTY1NWE1YyJ9fX0="}]}}}
execute if score $rand random matches 1 run item replace entity @e[type=armor_stand,tag=rap_royalty] armor.head with player_head{SkullOwner:{Id:[I;-1613881894,827542653,-1874591674,-334817177],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNzI0ZjUwNGVlNDQ2ZTgzNzc0NmMzMTdhZjM2NGU0ZjA0Njc1ZTRhYmY3ZDMyYTg0MTU4ZmExMTQyYTM0ZDE1In19fQ=="}]}}}
execute if score $rand random matches 2 run item replace entity @e[type=armor_stand,tag=rap_royalty] armor.head with player_head{SkullOwner:{Id:[I;1614423346,-960870741,-1156301796,298394597],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvYzAyZWFkYzgzN2MzM2FhYzc0ZjU3MDgxNDE0MDVkZWY2MDljNGJmOTk3NDg0M2VkYjBkMDY4YmI5OTU1NzIifX19"}]}}}
execute if score $rand random matches 3 run item replace entity @e[type=armor_stand,tag=rap_royalty] armor.head with player_head{SkullOwner:{Id:[I;1604549352,782583714,-2069938771,500332533],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvZGUzMDJjYWFkYmZhY2M1ZjI2ZjBmNzgzMzQyY2QyZDYzYzVjYzBiZTZkZDE0MThjMDQzNmE2YWQ0NWRmZjc4In19fQ=="}]}}}
execute if score $rand random matches 4 run item replace entity @e[type=armor_stand,tag=rap_royalty] armor.head with player_head{SkullOwner:{Id:[I;1885375923,-530888850,-1517412782,1965436931],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvN2VjYWNmNDc1ZWI5ZDNmNjQ0ZjJhMDFkNWNjNDk3YzMyODk1ZmQzNDc2MTMyZmYzOTI4ZTY0NzY2YjVlZmYwIn19fQ=="}]}}}
execute if score $rand random matches 5 run item replace entity @e[type=armor_stand,tag=rap_royalty] armor.head with player_head{SkullOwner:{Id:[I;1305277367,-118207143,-1406782056,-356107569],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvMjY2OGU4MTc0ZjYxMTA0OTQwNjM5ZDk3ZWRlMDM4MTkyMDE4OTcxMWYxNGQyZWE2Zjg1OGE0NDc2N2Y2ZWIifX19"}]}}}
execute if score $rand random matches 6 run item replace entity @e[type=armor_stand,tag=rap_royalty] armor.head with player_head{SkullOwner:{Id:[I;813198219,-1981398055,-1238471564,-567694501],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvZTUxMGI1Yjc3OGZkZTQ5NzRjMGJiYzlkN2FkNDMwNzZkYjZjNGFlZGIwNjMwYTE0ZDgyNTNlZWQxNmQzMjAzYyJ9fX0="}]}}}
execute if score $rand random matches 7 run item replace entity @e[type=armor_stand,tag=rap_royalty] armor.head with player_head{SkullOwner:{Id:[I;-1950266508,-957134031,-1322199960,1133624341],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvYjY1YTA2NjMxMTFjYzlmNjEzMmMxYzE0NmFhZTc5MGZjODgxNmUxY2VmYzRhNWE0MjYyYWNkMDYzZGNiMWI5MiJ9fX0="}]}}}
execute if score $rand random matches 8 run item replace entity @e[type=armor_stand,tag=rap_royalty] armor.head with player_head{SkullOwner:{Id:[I;1280456731,859259179,-1688568064,-593579021],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvOGUyZDMyOGZmNjRiMjlhYjA2ZmY4YmE4NTNmN2Q4NTkyZDA5MDg2MTAyMTI2ZjkzYzk4NmMxYWZhN2I5NDMyZSJ9fX0="}]}}}
execute if score $rand random matches 9 run item replace entity @e[type=armor_stand,tag=rap_royalty] armor.head with player_head{SkullOwner:{Id:[I;-1288184360,1833779312,-2016919635,610042656],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvZDNlMmJlNmUyMmRiYjc5MWMxZWQ3YTdmZmMwMGQyMmI4ZjA2NTE4MjExYjc0YTNjYTBmY2M0YWJkYjE4NzQzZSJ9fX0="}]}}}

execute if score $rand random matches 10 run item replace entity @e[type=armor_stand,tag=rap_royalty] armor.head with player_head{SkullOwner:{Id:[I;1175390414,661344010,-1954802415,1780316196],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvYzU1Y2RmNmEzOTZhZjc4MzcwZWVkMTJkODFmMTc1ZGQ2NDM3ODk3YTMzMjY0Nzc1ODVhYzNiM2FkOWNlIn19fQ=="}]}}}
execute if score $rand random matches 11 run item replace entity @e[type=armor_stand,tag=rap_royalty] armor.head with player_head{SkullOwner:{Id:[I;62015952,1998080831,-1341996693,-2129857460],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvMWFiODE0MTFiODgxYmU5OWRkY2JiYWYzYjY3MGY3ZGE4MmQ5YTdhZWYyNWViZWFkYzdhOTRmMWEzMmMzMWZlYiJ9fX0="}]}}}
execute if score $rand random matches 12 run item replace entity @e[type=armor_stand,tag=rap_royalty] armor.head with player_head{SkullOwner:{Id:[I;-767246012,-2068035190,-1500281232,-395372756],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvOTBhNDRiNzBiMDY4ZjlkM2YxYWQ3YzExODllOWE0M2E2YjFiNjdkNTllZDQzOTI0MzlmYTk4ZGNmNWJiNDU5In19fQ=="}]}}}
execute if score $rand random matches 13 run item replace entity @e[type=armor_stand,tag=rap_royalty] armor.head with player_head{SkullOwner:{Id:[I;1286098908,-816036117,-2016887260,-668477502],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvODhlM2E2Y2VhM2E4ZGQxNjNiNTZmNTA4ZTQzYzg1M2JjMjAxNTg5NmNkMjY2MmNjYTI2MWJlZTQ5ZjRiNTkxOSJ9fX0="}]}}}
execute if score $rand random matches 14 run item replace entity @e[type=armor_stand,tag=rap_royalty] armor.head with player_head{SkullOwner:{Id:[I;1163838309,-1157347157,-2120766836,-226625559],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNTA1MjExZDMwNDNjMzM0MDhmNTMwZTJhZTNmNzkzOGIwN2I1ZWY3NzVkZDBlMzA3MGE5ZGZhOTQyNTJiNDdmYiJ9fX0="}]}}}
execute if score $rand random matches 15 run item replace entity @e[type=armor_stand,tag=rap_royalty] armor.head with player_head{SkullOwner:{Id:[I;409125494,1198868093,-2064007295,1246753132],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvYWUzZTM2MTRjNWYzMzViZGY1YzRiOTc0ZDE5MzMwZjI5ODdjNGE5ZTNiZGRmODhkMzU3YzY3YTJiY2YzIn19fQ=="}]}}}
execute if score $rand random matches 16 run item replace entity @e[type=armor_stand,tag=rap_royalty] armor.head with player_head{SkullOwner:{Id:[I;1318003623,1079460774,-2101492994,-91288918],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvZWNiNzUxNmU3YzVkN2QzZDcxN2Y4Mzg2MTVjYmM4NjMzYmJiZmVjNGMwZjQ5YzYzZWVlNTRjMTlmZTU2Zjc2In19fQ=="}]}}}
execute if score $rand random matches 17 run item replace entity @e[type=armor_stand,tag=rap_royalty] armor.head with player_head{SkullOwner:{Id:[I;1616333034,-2087563393,-2039287843,-2037473979],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvYzQxZWQwZWJjOTVlZTFjYmU5ZjAyYzM1MzMxYzU1YzZlYzY3MjE1ZjE4ZGJkZTU2MDM0OGFiMzU2MWI0MjQwMCJ9fX0="}]}}}
execute if score $rand random matches 18 run item replace entity @e[type=armor_stand,tag=rap_royalty] armor.head with player_head{SkullOwner:{Id:[I;-1505149583,-785625762,-2073401460,638366199],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvYzVlOWQ4NzJlYThmMDFhMDQwYzFiNDU5MmFmMThkYTc5N2EyZGVkMjRjMDE3M2Q5MTUwODNkMzJmODU1MzMxMyJ9fX0="}]}}}
execute if score $rand random matches 19 run item replace entity @e[type=armor_stand,tag=rap_royalty] armor.head with player_head{SkullOwner:{Id:[I;-391674442,-451853149,-1490681435,1595641323],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvMmY1ODhlNzU4YTM3ZmZhYWJkN2M0Yjk2MWQ0M2M4YmQ5ZGRmMDk2N2Q4ZWNjZGQ2MzAzMmJiNjVmZjViMTAwMSJ9fX0="}]}}}

execute if score $rand random matches 10.. run item replace entity @e[type=armor_stand,tag=rap_royalty] armor.chest with leather_chestplate{display:{color:10682585}}
execute if score $rand random matches 10.. run item replace entity @e[type=armor_stand,tag=rap_royalty] armor.feet with leather_boots{display:{color:10682585}}
...
# giving players armor
item replace entity @a[team=rap] armor.chest with netherite_chestplate{HideFlags:63,Enchantments:[{id:"binding_curse",lvl:1},{id:"protection",lvl:6}],display:{Name:'[{"text":"Chestplate","italic":false,"color":"gray"}]'}}
item replace entity @a[team=rap] armor.legs with netherite_leggings{HideFlags:63,Enchantments:[{id:"binding_curse",lvl:1},{id:"protection",lvl:6}],display:{Name:'[{"text":"Leggings","italic":false,"color":"gray"}]'}}
item replace entity @a[team=rap] armor.feet with netherite_boots{HideFlags:63,Enchantments:[{id:"binding_curse",lvl:1},{id:"protection",lvl:6}],display:{Name:'[{"text":"Boots","italic":false,"color":"gray"}]'}}


advancement grant @a[team=rap,tag=playing,gamemode=adventure] only advancements:scenario_rescue