...
replaceitem entity @a[team=wyr] hotbar.2 lime_concrete{display:{Name:"[{\"text\":\"Press \",\"italic\":false,\"color\":\"green\"},{\"keybind\":\"key.drop\",\"italic\":false},{\"text\":\" to vote: \\\"Succeed\\\"\",\"color\":\"green\",\"italic\":false}]"},Die:1}

replaceitem entity @a[team=wyr] hotbar.4 purple_concrete{display:{Name:"[{\"text\":\"Press \",\"italic\":false,\"color\":\"light_purple\"},{\"keybind\":\"key.drop\",\"italic\":false},{\"text\":\" to: \\\"Abstain\\\"\",\"color\":\"light_purple\",\"italic\":false}]"},Die:1}

replaceitem entity @a[team=wyr] hotbar.6 red_concrete{display:{Name:"[{\"text\":\"Press \",\"italic\":false,\"color\":\"red\"},{\"keybind\":\"key.drop\",\"italic\":false},{\"text\":\" to vote: \\\"Fail\\\"\",\"color\":\"red\",\"italic\":false}]"},Die:1}