...
summon minecraft:armor_stand 15991 67 -374 {Invulnerable:1b,Tags:["rab_die"],ShowArms:1b,NoBasePlate:1b,ArmorItems:[{id:"minecraft:leather_boots",Count:1b,tag:{display:{color:4005321}}},{id:"minecraft:leather_leggings",Count:1b,tag:{display:{color:1048914}}},{id:"minecraft:leather_chestplate",Count:1b,tag:{display:{color:1447446}}},{id:"minecraft:player_head",Count:1b,tag:{SkullOwner:{Id:[I;-796960497,-901756212,-1683984480,-1320724688],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvYjE5Njc2YzFjN2Y0ZGY5MGYwN2MyZGM0NDE0YThhY2IyZjBiYTZmZjI3NWYwY2FmOGMzZDEzNjc1YzEyNzdmMCJ9fX0="}]}}}}],Pose:{RightArm:[-45.0f,0.0f,0.0f],LeftArm:[-45.0f,0.0f,0.0f]}}
