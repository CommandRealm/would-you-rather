...
summon area_effect_cloud 15927 62 -382 {Duration:10000,Tags:["infinite","rab_elevator","rab_up"]}
scoreboard players set $time rab_elevator 500
clone 15920 74 -382 15920 76 -380 15927 70 -382
tag @e remove rab_on_ele
tag @e[x=15922,y=62,z=-383,dx=5,dz=4,dy=5,type=!area_effect_cloud] add rab_on_ele
