...
scoreboard objectives remove bam_old_seconds
scoreboard objectives add bam_old_seconds dummy {"text":"Time Remaining","color":"aqua","bold":true}

scoreboard objectives add bam_old_bar dummy
scoreboard objectives remove bam_old_break_d
scoreboard objectives add bam_old_break_d minecraft.mined:minecraft.diamond_ore


scoreboard objectives add bam_old_timer dummy

tag @e[tag=bam_old_spawn,type=area_effect_cloud] remove bam_old_diamond
execute as @e[tag=bam_old_spawn,type=area_effect_cloud] at @s run setblock ~ ~ ~ diamond_ore
...
execute if entity @a[team=bam_old,tag=tutorial] run schedule function scenario:become_a_miner_old/tutorial_setup 40t
execute unless entity @a[team=bam_old,tag=tutorial] run schedule function scenario:check_countdown 40t
scoreboard players set @a[tag=playing,team=bam_old] death 0
kill @e[type=area_effect_cloud,tag=bam_old_shaft]
summon area_effect_cloud 8997 88 -2 {Duration:100000,Tags:["infinite","bam_old_shaft"]}
kill @e[type=area_effect_cloud,tag=bam_old_platform]
...
scoreboard objectives add bam_old_dummy dummy
scoreboard objectives remove bam_old_diamond
scoreboard objectives add bam_old_diamond dummy
scoreboard players add @a[team=bam_old] bam_old_diamond 0

execute as @a[team=bam_old] at @s run kill @e[type=item,distance=..200,nbt={Item:{id:"minecraft:iron_pickaxe"}}]
execute as @a[team=bam_old] at @s run kill @e[type=item,distance=..200,nbt={Item:{id:"minecraft:minecart"}}]
execute as @a[team=bam_old] at @s run kill @e[type=item,distance=..200,nbt={Item:{id:"minecraft:diamond"}}]

execute as @a[team=bam_old] at @s run kill @e[tag=bam_old_minecart,distance=..200]
summon minecraft:minecart 9012 67 24 {Tags:["die","bam_old_minecart"]}