...
execute if score $rand random matches 0 run setblock 30000 5 0 oak_sign{front_text:{messages:['[{"selector":"@e[tag=ddp_name,sort=random,limit=1]","italic":false},{"text":" Potion","color":"aqua"}]', '{"text":""}', '{"text":""}', '{"text":""}'], has_glowing_text: false, color: "black"}} destroy
execute if score $rand random matches 1 run setblock 30000 5 0 oak_sign{front_text:{messages:['[{"selector":"@e[tag=ddp_name,sort=random,limit=1]","italic":false},{"text":" Potion","color":"black"}]', '{"text":""}', '{"text":""}', '{"text":""}'], has_glowing_text: false, color: "black"}} destroy
execute if score $rand random matches 2 run setblock 30000 5 0 oak_sign{front_text:{messages:['[{"selector":"@e[tag=ddp_name,sort=random,limit=1]","italic":false},{"text":" Potion","color":"blue"}]', '{"text":""}', '{"text":""}', '{"text":""}'], has_glowing_text: false, color: "black"}} destroy
execute if score $rand random matches 3 run setblock 30000 5 0 oak_sign{front_text:{messages:['[{"selector":"@e[tag=ddp_name,sort=random,limit=1]","italic":false},{"text":" Potion","color":"dark_aqua"}]', '{"text":""}', '{"text":""}', '{"text":""}'], has_glowing_text: false, color: "black"}} destroy
execute if score $rand random matches 4 run setblock 30000 5 0 oak_sign{front_text:{messages:['[{"selector":"@e[tag=ddp_name,sort=random,limit=1]","italic":false},{"text":" Potion","color":"dark_blue"}]', '{"text":""}', '{"text":""}', '{"text":""}'], has_glowing_text: false, color: "black"}} destroy
execute if score $rand random matches 5 run setblock 30000 5 0 oak_sign{front_text:{messages:['[{"selector":"@e[tag=ddp_name,sort=random,limit=1]","italic":false},{"text":" Potion","color":"dark_gray"}]', '{"text":""}', '{"text":""}', '{"text":""}'], has_glowing_text: false, color: "black"}} destroy
execute if score $rand random matches 6 run setblock 30000 5 0 oak_sign{front_text:{messages:['[{"selector":"@e[tag=ddp_name,sort=random,limit=1]","italic":false},{"text":" Potion","color":"dark_green"}]', '{"text":""}', '{"text":""}', '{"text":""}'], has_glowing_text: false, color: "black"}} destroy
execute if score $rand random matches 7 run setblock 30000 5 0 oak_sign{front_text:{messages:['[{"selector":"@e[tag=ddp_name,sort=random,limit=1]","italic":false},{"text":" Potion","color":"dark_purple"}]', '{"text":""}', '{"text":""}', '{"text":""}'], has_glowing_text: false, color: "black"}} destroy
execute if score $rand random matches 8 run setblock 30000 5 0 oak_sign{front_text:{messages:['[{"selector":"@e[tag=ddp_name,sort=random,limit=1]","italic":false},{"text":" Potion","color":"dark_red"}]', '{"text":""}', '{"text":""}', '{"text":""}'], has_glowing_text: false, color: "black"}} destroy
execute if score $rand random matches 9 run setblock 30000 5 0 oak_sign{front_text:{messages:['[{"selector":"@e[tag=ddp_name,sort=random,limit=1]","italic":false},{"text":" Potion","color":"gold"}]', '{"text":""}', '{"text":""}', '{"text":""}'], has_glowing_text: false, color: "black"}} destroy
execute if score $rand random matches 10 run setblock 30000 5 0 oak_sign{front_text:{messages:['[{"selector":"@e[tag=ddp_name,sort=random,limit=1]","italic":false},{"text":" Potion","color":"gray"}]', '{"text":""}', '{"text":""}', '{"text":""}'], has_glowing_text: false, color: "black"}} destroy
execute if score $rand random matches 11 run setblock 30000 5 0 oak_sign{front_text:{messages:['[{"selector":"@e[tag=ddp_name,sort=random,limit=1]","italic":false},{"text":" Potion","color":"green"}]', '{"text":""}', '{"text":""}', '{"text":""}'], has_glowing_text: false, color: "black"}} destroy
execute if score $rand random matches 12 run setblock 30000 5 0 oak_sign{front_text:{messages:['[{"selector":"@e[tag=ddp_name,sort=random,limit=1]","italic":false},{"text":" Potion","color":"light_purple"}]', '{"text":""}', '{"text":""}', '{"text":""}'], has_glowing_text: false, color: "black"}} destroy
execute if score $rand random matches 13 run setblock 30000 5 0 oak_sign{front_text:{messages:['[{"selector":"@e[tag=ddp_name,sort=random,limit=1]","italic":false},{"text":" Potion","color":"red"}]', '{"text":""}', '{"text":""}', '{"text":""}'], has_glowing_text: false, color: "black"}} destroy
execute if score $rand random matches 14 run setblock 30000 5 0 oak_sign{front_text:{messages:['[{"selector":"@e[tag=ddp_name,sort=random,limit=1]","italic":false},{"text":" Potion","color":"white"}]', '{"text":""}', '{"text":""}', '{"text":""}'], has_glowing_text: false, color: "black"}} destroy
execute if score $rand random matches 15 run setblock 30000 5 0 oak_sign{front_text:{messages:['[{"selector":"@e[tag=ddp_name,sort=random,limit=1]","italic":false},{"text":" Potion","color":"yellow"}]', '{"text":""}', '{"text":""}', '{"text":""}'], has_glowing_text: false, color: "black"}} destroy
