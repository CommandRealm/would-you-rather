...
execute unless score $correct dab_state matches 1 run tellraw @a[team=dab,tag=playing,gamemode=adventure] ["",{"text":"\n- Of these blocks:\n- ","color":"gray"},{"score":{"objective":"dab_state","name":"$correct"},"color":"#18ff00","bold":true},{"text":" were Correct. ","color":"#18ff00"},{"text":"[?]","color":"gold","underlined":true,"hoverEvent":{"action":"show_text","contents":{"text":"These colors are supposed to be in the code and are in the right spot.","color":"green"}}}]
execute if score $correct dab_state matches 1 run tellraw @a[team=dab,tag=playing,gamemode=adventure] ["",{"text":"\n- Of these blocks:\n- ","color":"gray"},{"score":{"objective":"dab_state","name":"$correct"},"color":"#18ff00","bold":true},{"text":" was Correct. ","color":"#18ff00"},{"text":"[?]","color":"gold","underlined":true,"hoverEvent":{"action":"show_text","contents":{"text":"One of these colors is supposed to be in the code and is in the right spot.","color":"green"}}}]
execute unless score $incorrect dab_state matches 1 run tellraw @a[team=dab,tag=playing,gamemode=adventure] ["",{"text":"- ","color":"gray"},{"score":{"objective":"dab_state","name":"$incorrect"},"color":"#f7000c","bold":true},{"text":" were Incorrect. ","color":"#f7000c"},{"text":"[?]","color":"gold","underlined":true,"hoverEvent":{"action":"show_text","contents":{"text":"These colors are not in the code.","color":"green"}}}]
execute if score $incorrect dab_state matches 1 run tellraw @a[team=dab,tag=playing,gamemode=adventure] ["",{"text":"- ","color":"gray"},{"score":{"objective":"dab_state","name":"$incorrect"},"color":"#f7000c","bold":true},{"text":" was Incorrect. ","color":"#f7000c"},{"text":"[?]","color":"gold","underlined":true,"hoverEvent":{"action":"show_text","contents":{"text":"One of these colors is not in the code.","color":"green"}}}]
execute unless score $misplaced dab_state matches 1 run tellraw @a[team=dab,tag=playing,gamemode=adventure] ["",{"text":"- ","color":"gray"},{"score":{"objective":"dab_state","name":"$misplaced"},"color":"#5060d3","bold":true},{"text":" were Misplaced. ","color":"#5060d3"},{"text":"[?]","color":"gold","underlined":true,"hoverEvent":{"action":"show_text","contents":{"text":"These colors are supposed to be in the code but are in the wrong spot.","color":"green"}}}]
execute if score $misplaced dab_state matches 1 run tellraw @a[team=dab,tag=playing,gamemode=adventure] ["",{"text":"- ","color":"gray"},{"score":{"objective":"dab_state","name":"$misplaced"},"color":"#5060d3","bold":true},{"text":" was Misplaced. ","color":"#5060d3"},{"text":"[?]","color":"gold","underlined":true,"hoverEvent":{"action":"show_text","contents":{"text":"One of these colors is supposed to be in the code but is in the wrong spot.","color":"green"}}}]
