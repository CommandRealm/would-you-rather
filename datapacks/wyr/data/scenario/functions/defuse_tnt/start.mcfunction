...
summon area_effect_cloud 25989 78.0 5 {Duration:3600000,Invulnerable:1b,Tags:["die","dab_text"],CustomNameVisible:1b,CustomName:'{"text":"Place blocks here to guess the code!","color":"gold"}'}
