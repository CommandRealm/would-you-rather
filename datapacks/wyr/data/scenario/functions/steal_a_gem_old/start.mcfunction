...
summon item 16000 60 0 {NoGravity:1b,Tags:["rab_old_item","rab_old_die"],Item:{id:"minecraft:stick",Count:1b,tag:{rab_old_melee:1,Enchantments:[{id:"minecraft:knockback",lvl:5}],display:{Name:'[{"text":"Baseball Bat","italic":false,"color":"#93572f"}]'}}}}
summon item 16000 60 0 {NoGravity:1b,Tags:["rab_old_item","rab_old_die"],Item:{id:"minecraft:potion",Count:1b,tag:{HideFlags:63,display:{Name:'{"text":"Energy Drink","italic":false,"color":"dark_blue"}'},CustomPotionColor:2714506,custom_potion_effects:[{id:"minecraft:speed",amplifier:2,show_icon:1b,show_particles:1b,duration:300}]}}}
summon item 16000 60 0 {NoGravity:1b,Tags:["rab_old_item","rab_old_die"],Item:{id:"minecraft:potion",Count:1b,tag:{HideFlags:63,display:{Name:'{"text":"Energy Drink","italic":false,"color":"dark_blue"}'},CustomPotionColor:2714506,custom_potion_effects:[{id:"minecraft:speed",amplifier:2,show_icon:1b,show_particles:1b,duration:300}]}}}
