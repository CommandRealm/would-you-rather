...
execute if score $punch settings matches 0 run setblock -940 79 -131 oak_wall_sign[facing=north]{Text1:'{"text":"Punching in","color":"dark_green","bold":true,"clickEvent":{"action":"run_command","value":"/execute if score $game state matches 1.. run function options:error"}}',Text2:'{"text":"studio","color":"dark_green","bold":true}',Text3:'{"text":"Off","color":"red"}',Text4:'{"text":"<<<         >>>","color":"aqua","bold":true,"clickEvent":{"action":"run_command","value":"/execute as @s at @s anchored eyes if score $game state matches 0 run function options:punch/click_punch"}}'}
execute if score $punch settings matches 1 run setblock -940 79 -131 oak_wall_sign[facing=north]{Text1:'{"text":"Punching in","color":"dark_green","bold":true,"clickEvent":{"action":"run_command","value":"/execute if score $game state matches 1.. run function options:error"}}',Text2:'{"text":"studio","color":"dark_green","bold":true}',Text3:'{"text":"On","color":"dark_green"}',Text4:'{"text":"<<<         >>>","color":"aqua","bold":true,"clickEvent":{"action":"run_command","value":"/execute as @s at @s anchored eyes if score $game state matches 0 run function options:punch/click_punch"}}'}
