...
execute if score $number fast_mode matches 1 run setblock -936 79 -129 oak_wall_sign[facing=north]{front_text:{messages:['{"text":"Intro","color":"yellow","bold":true,"clickEvent":{"action":"run_command","value":"/execute if score $game state matches 1.. run function options:error"}}', '{"text":"show:","color":"yellow","bold":true}', '{"text":"Off","color":"red"}', '{"text":"<<<         >>>","color":"aqua","bold":true,"clickEvent":{"action":"run_command","value":"/execute as @s at @s anchored eyes if score $game state matches 0 run function options:fast/click_fast"}}'], has_glowing_text: false, color: "black"}}
execute if score $number fast_mode matches 0 run setblock -936 79 -129 oak_wall_sign[facing=north]{front_text:{messages:['{"text":"Intro","color":"yellow","bold":true,"clickEvent":{"action":"run_command","value":"/execute if score $game state matches 1.. run function options:error"}}', '{"text":"show:","color":"yellow","bold":true}', '{"text":"On","color":"green"}', '{"text":"<<<         >>>","color":"aqua","bold":true,"clickEvent":{"action":"run_command","value":"/execute as @s at @s anchored eyes if score $game state matches 0 run function options:fast/click_fast"}}'], has_glowing_text: false, color: "black"}}
