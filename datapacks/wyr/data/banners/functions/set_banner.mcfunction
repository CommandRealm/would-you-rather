...
execute if entity @s[scores={banners=16}] as @e[type=area_effect_cloud,tag=lobby_banner] at @s run fill ~ ~ ~ ~ ~ ~ black_wall_banner[facing=north]{Patterns:[{Color:15,Pattern:"bri"},{Color:3,Pattern:"bri"},{Color:15,Pattern:"cbo"},{Color:15,Pattern:"bs"},{Color:15,Pattern:"ts"},{Color:0,Pattern:"mc"}]} replace #banners[facing=north]
execute if entity @s[scores={banners=16}] as @e[type=area_effect_cloud,tag=lobby_banner] at @s run fill ~ ~ ~ ~ ~ ~ black_wall_banner[facing=west]{Patterns:[{Color:15,Pattern:"bri"},{Color:3,Pattern:"bri"},{Color:15,Pattern:"cbo"},{Color:15,Pattern:"bs"},{Color:15,Pattern:"ts"},{Color:0,Pattern:"mc"}]} replace #banners[facing=west]
execute if entity @s[scores={banners=16}] as @e[type=area_effect_cloud,tag=lobby_banner] at @s run fill ~ ~ ~ ~ ~ ~ black_wall_banner[facing=south]{Patterns:[{Color:15,Pattern:"bri"},{Color:3,Pattern:"bri"},{Color:15,Pattern:"cbo"},{Color:15,Pattern:"bs"},{Color:15,Pattern:"ts"},{Color:0,Pattern:"mc"}]} replace #banners[facing=south]
execute if entity @s[scores={banners=16}] as @e[type=area_effect_cloud,tag=lobby_banner] at @s run fill ~ ~ ~ ~ ~ ~ black_wall_banner[facing=east]{Patterns:[{Color:15,Pattern:"bri"},{Color:3,Pattern:"bri"},{Color:15,Pattern:"cbo"},{Color:15,Pattern:"bs"},{Color:15,Pattern:"ts"},{Color:0,Pattern:"mc"}]} replace #banners[facing=east]
