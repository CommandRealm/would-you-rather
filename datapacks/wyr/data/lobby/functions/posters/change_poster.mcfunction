...
execute if score $poster poster_time matches 9.. run scoreboard players set $poster poster_time 1
...
execute if score $poster poster_time matches 7 run function lobby:posters/kb
execute if score $poster poster_time matches 8 run function lobby:posters/cr
