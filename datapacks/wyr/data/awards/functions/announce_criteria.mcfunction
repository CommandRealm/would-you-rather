...
execute if entity @e[type=area_effect_cloud,tag=award,tag=choose_award,tag=awd_water] as @a[tag=playing] at @s run scoreboard players operation @s award_calculate = @s awd_water
execute if entity @e[type=area_effect_cloud,tag=award,tag=choose_award,tag=awd_fire] as @a[tag=playing] at @s run scoreboard players operation @s award_calculate = @s awd_fire
execute if entity @e[type=area_effect_cloud,tag=award,tag=choose_award,tag=awd_thievery] as @a[tag=playing] at @s run scoreboard players operation @s award_calculate = @s awd_thievery
execute if entity @e[type=area_effect_cloud,tag=award,tag=choose_award,tag=awd_lawful] as @a[tag=playing] at @s run scoreboard players operation @s award_calculate = @s awd_thievery
execute if entity @e[type=area_effect_cloud,tag=award,tag=choose_award,tag=awd_armor] as @a[tag=playing] at @s run scoreboard players operation @s award_calculate = @s awd_armor

execute if entity @e[type=area_effect_cloud,tag=award,tag=choose_award,tag=awd_gene_l] run tag @r[tag=playing] add award_winner
...
execute if entity @e[type=area_effect_cloud,tag=award,tag=choose_award,tag=awd_gene_l] run scoreboard players set @a[tag=playing] fake_awards 1000
...
execute if entity @e[type=area_effect_cloud,tag=award,tag=choose_award,tag=awd_sel_time] run tellraw @a [{"text":"<","color":"blue"},{"text":"Gene","color":"aqua"},{"text":"> ","color":"blue"},{"text":"With ","color":"aqua"},{"score":{"objective":"award_calculate","name":"@r[tag=award_winner,tag=playing,scores={fake_awards=0}]"}},{"text":" seconds choosing scenarios, the award goes to . . .","color":"aqua"}]
execute if entity @e[type=area_effect_cloud,tag=award,tag=choose_award,tag=awd_run] run tellraw @a [{"text":"<","color":"blue"},{"text":"Gene","color":"aqua"},{"text":"> ","color":"blue"},{"text":"With ","color":"aqua"},{"score":{"objective":"award_calculate","name":"@r[tag=award_winner,tag=playing,scores={fake_awards=0}]"}},{"text":" blocks ran, the award goes to . . .","color":"aqua"}]
execute if entity @e[type=area_effect_cloud,tag=award,tag=choose_award,tag=awd_fail] run tellraw @a [{"text":"<","color":"blue"},{"text":"Gene","color":"aqua"},{"text":"> ","color":"blue"},{"text":"With ","color":"aqua"},{"score":{"objective":"award_calculate","name":"@r[tag=award_winner,tag=playing,scores={fake_awards=0}]"}},{"text":" scenarios failed, the award goes to . . .","color":"aqua"}]
execute if entity @e[type=area_effect_cloud,tag=award,tag=choose_award,tag=awd_companions] run tellraw @a [{"text":"<","color":"blue"},{"text":"Gene","color":"aqua"},{"text":"> ","color":"blue"},{"text":"With ","color":"aqua"},{"score":{"objective":"award_calculate","name":"@r[tag=award_winner,tag=playing,scores={fake_awards=0}]"}},{"text":" companions in scenarios, the award goes to . . .","color":"aqua"}]
execute if entity @e[type=area_effect_cloud,tag=award,tag=choose_award,tag=awd_companions_2] run tellraw @a [{"text":"<","color":"blue"},{"text":"Gene","color":"aqua"},{"text":"> ","color":"blue"},{"text":"With ","color":"aqua"},{"score":{"objective":"award_calculate","name":"@r[tag=award_winner,tag=playing,scores={fake_awards=0}]"}},{"text":" companions in scenarios, the award goes to . . .","color":"aqua"}]
execute if entity @e[type=area_effect_cloud,tag=award,tag=choose_award,tag=awd_random] run tellraw @a [{"text":"<","color":"blue"},{"text":"Gene","color":"aqua"},{"text":"> ","color":"blue"},{"text":"With ","color":"aqua"},{"score":{"objective":"award_calculate","name":"@r[tag=award_winner,tag=playing,scores={fake_awards=0}]"}},{"text":" random scenario decisions, the award goes to . . .","color":"aqua"}]
execute if entity @e[type=area_effect_cloud,tag=award,tag=choose_award,tag=awd_jump] run tellraw @a [{"text":"<","color":"blue"},{"text":"Gene","color":"aqua"},{"text":"> ","color":"blue"},{"text":"With ","color":"aqua"},{"score":{"objective":"award_calculate","name":"@r[tag=award_winner,tag=playing,scores={fake_awards=0}]"}},{"text":" jumps, the award goes to . . .","color":"aqua"}]
...
execute if entity @e[type=area_effect_cloud,tag=award,tag=choose_award,tag=awd_spectate] run tellraw @a [{"text":"<","color":"blue"},{"text":"Gene","color":"aqua"},{"text":"> ","color":"blue"},{"text":"With ","color":"aqua"},{"score":{"objective":"award_calculate","name":"@r[tag=award_winner,tag=playing,scores={fake_awards=0}]"}},{"text":" seconds spectating, the award goes to . . .","color":"aqua"}]
execute if entity @e[type=area_effect_cloud,tag=award,tag=choose_award,tag=awd_drop] run tellraw @a [{"text":"<","color":"blue"},{"text":"Gene","color":"aqua"},{"text":"> ","color":"blue"},{"text":"With ","color":"aqua"},{"score":{"objective":"award_calculate","name":"@r[tag=award_winner,tag=playing,scores={fake_awards=0}]"}},{"text":" items dropped, the award goes to . . .","color":"aqua"}]
execute if entity @e[type=area_effect_cloud,tag=award,tag=choose_award,tag=awd_sneak] run tellraw @a [{"text":"<","color":"blue"},{"text":"Gene","color":"aqua"},{"text":"> ","color":"blue"},{"text":"With ","color":"aqua"},{"score":{"objective":"award_calculate","name":"@r[tag=award_winner,tag=playing,scores={fake_awards=0}]"}},{"text":" seconds crouched, the award goes to . . .","color":"aqua"}]
execute if entity @e[type=area_effect_cloud,tag=award,tag=choose_award,tag=awd_taken] run tellraw @a [{"text":"<","color":"blue"},{"text":"Gene","color":"aqua"},{"text":"> ","color":"blue"},{"text":"With ","color":"aqua"},{"score":{"objective":"award_calculate","name":"@r[tag=award_winner,tag=playing,scores={fake_awards=0}]"}},{"text":" damage points taken, the award goes to . . .","color":"aqua"}]
execute if entity @e[type=area_effect_cloud,tag=award,tag=choose_award,tag=awd_dealt] run tellraw @a [{"text":"<","color":"blue"},{"text":"Gene","color":"aqua"},{"text":"> ","color":"blue"},{"text":"With ","color":"aqua"},{"score":{"objective":"award_calculate","name":"@r[tag=award_winner,tag=playing,scores={fake_awards=0}]"}},{"text":" damage points dealt, the award goes to . . .","color":"aqua"}]
execute if entity @e[type=area_effect_cloud,tag=award,tag=choose_award,tag=awd_in_scenario] run tellraw @a [{"text":"<","color":"blue"},{"text":"Gene","color":"aqua"},{"text":"> ","color":"blue"},{"text":"With ","color":"aqua"},{"score":{"objective":"award_calculate","name":"@r[tag=award_winner,tag=playing,scores={fake_awards=0}]"}},{"text":" seconds playing scenarios, the award goes to . . .","color":"aqua"}]
execute if entity @e[type=area_effect_cloud,tag=award,tag=choose_award,tag=awd_mob_kills] run tellraw @a [{"text":"<","color":"blue"},{"text":"Gene","color":"aqua"},{"text":"> ","color":"blue"},{"text":"With ","color":"aqua"},{"score":{"objective":"award_calculate","name":"@r[tag=award_winner,tag=playing,scores={fake_awards=0}]"}},{"text":" mob kills, the award goes to . . .","color":"aqua"}]
...
execute if entity @e[type=area_effect_cloud,tag=award,tag=choose_award,tag=awd_hold_item] run tellraw @a [{"text":"<","color":"blue"},{"text":"Gene","color":"aqua"},{"text":"> ","color":"blue"},{"text":"With ","color":"aqua"},{"score":{"objective":"award_calculate","name":"@r[tag=award_winner,tag=playing,scores={fake_awards=0}]"}},{"text":" seconds holding an item, the award goes to . . .","color":"aqua"}]

execute if entity @e[type=area_effect_cloud,tag=award,tag=choose_award,tag=awd_water] run tellraw @a [{"text":"<","color":"blue"},{"text":"Gene","color":"aqua"},{"text":"> ","color":"blue"},{"text":"With ","color":"aqua"},{"score":{"objective":"award_calculate","name":"@r[tag=award_winner,tag=playing,scores={fake_awards=0}]"}},{"text":" seconds in water, the award goes to . . .","color":"aqua"}]
execute if entity @e[type=area_effect_cloud,tag=award,tag=choose_award,tag=awd_fire] run tellraw @a [{"text":"<","color":"blue"},{"text":"Gene","color":"aqua"},{"text":"> ","color":"blue"},{"text":"With ","color":"aqua"},{"score":{"objective":"award_calculate","name":"@r[tag=award_winner,tag=playing,scores={fake_awards=0}]"}},{"text":" seconds on fire, the award goes to . . .","color":"aqua"}]
execute if entity @e[type=area_effect_cloud,tag=award,tag=choose_award,tag=awd_thievery] run tellraw @a [{"text":"<","color":"blue"},{"text":"Gene","color":"aqua"},{"text":"> ","color":"blue"},{"text":"With ","color":"aqua"},{"score":{"objective":"award_calculate","name":"@r[tag=award_winner,tag=playing,scores={fake_awards=0}]"}},{"text":" attempts at opening chests and other similar blocks, the award goes to . . .","color":"aqua"}]
execute if entity @e[type=area_effect_cloud,tag=award,tag=choose_award,tag=awd_lawful] run tellraw @a [{"text":"<","color":"blue"},{"text":"Gene","color":"aqua"},{"text":"> ","color":"blue"},{"text":"With ","color":"aqua"},{"score":{"objective":"award_calculate","name":"@r[tag=award_winner,tag=playing,scores={fake_awards=0}]"}},{"text":" attempts at opening chests and other similar blocks, the award goes to . . .","color":"aqua"}]
execute if entity @e[type=area_effect_cloud,tag=award,tag=choose_award,tag=awd_armor] run tellraw @a [{"text":"<","color":"blue"},{"text":"Gene","color":"aqua"},{"text":"> ","color":"blue"},{"text":"With ","color":"aqua"},{"score":{"objective":"award_calculate","name":"@r[tag=award_winner,tag=playing,scores={fake_awards=0}]"}},{"text":" seconds wearing armor, the award goes to . . .","color":"aqua"}]
execute if entity @e[type=area_effect_cloud,tag=award,tag=choose_award,tag=awd_gene_l] run tellraw @a [{"text":"<","color":"blue"},{"text":"Gene","color":"aqua"},{"text":"> ","color":"blue"},{"text":"This one will go to my personal least favorite! The award goes to . . .","color":"aqua"}]
