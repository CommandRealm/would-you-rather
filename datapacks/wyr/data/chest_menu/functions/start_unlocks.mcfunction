...
item replace entity @s[advancements={advancements:completionist/completionist=true}] enderchest.15 with gold_ingot{clickable:1,cosmetic:1,HideFlags:63,display:{Name:'[{"text":"Completionist Particles","bold":true,"italic":false,"color":"gold"}]',Lore:['[{"text":"Unlocked by completing all advancements.","italic":false,"color":"gray"}]']}}
...
item replace entity @s[tag=!no_completionist_particles,advancements={advancements:completionist/completionist=true}] enderchest.15 with gold_ingot{Enchantments:[{id:"minecraft:aqua_affinity",lvl:1}],clickable:1,cosmetic:1,HideFlags:63,display:{Name:'[{"text":"Completionist Particles","bold":true,"italic":false,"color":"gold"}]',Lore:['[{"text":"Unlocked by completing all advancements.","italic":false,"color":"gray"}]','[{"text":"Selected","italic":false,"color":"blue"}]']}}
